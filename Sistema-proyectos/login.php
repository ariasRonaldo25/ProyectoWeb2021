							...
							<div class="row">
								<div class="input-field col s12">
									<i class="material-icons prefix">account_circle</i>
							         <input  type="text" id="username" required placeholder="Ingresa tú email" class="validate">
								...
								<div class="input-field col s12">
									<i class="material-icons prefix">lock_outline</i>
							         <input type="password" id="password" required placeholder="Ingresa tú contraseña" class="validate">
								...
								<div class="col s12">
									<div class="center">
										...
										<p class="message">¿No estás registrado? <a href="register.php">Registrese.</a></p>
